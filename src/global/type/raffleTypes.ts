...
import { AchievementSource } from './badgeTypes';

export declare type RaffleFilterType = 'holder' | 'discord' | 'fifa' | 'achievement' | 'badge';
...
export declare type RaffleRewardType = 'SBT' | 'other' | 'erc20';
